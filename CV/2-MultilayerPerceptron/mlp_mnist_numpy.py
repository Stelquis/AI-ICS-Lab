...
# 数据路径：以脚本自身位置为基准定位，与运行时工作目录无关
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
input_path = os.path.join(SCRIPT_DIR, '..', 'data', 'MNIST')
...
show_images(images_2_show, titles_2_show, os.path.join(SCRIPT_DIR, 'mnist_samples.png'))
...
plt.tight_layout()
curves_path = os.path.join(SCRIPT_DIR, 'mlp_training_curves.png')
